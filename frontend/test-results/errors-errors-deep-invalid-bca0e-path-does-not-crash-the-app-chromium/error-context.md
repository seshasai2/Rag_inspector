...
- Name: errors.spec.ts >> errors >> deep invalid nested path does not crash the app
- Location: e2e\tests\errors.spec.ts:20:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at http://localhost:13000/queries/not-a-real-id-zzzz
Call log:
  - navigating to "http://localhost:13000/queries/not-a-real-id-zzzz", waiting until "load"
